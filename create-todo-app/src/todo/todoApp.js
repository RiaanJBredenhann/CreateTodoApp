...
class TodoApp extends React.Component {
    ...
    //-- this method will execute you start typing into the input field and will update the existing value --//
    ...
    //-- This will execute while you click the cross (x) button and will remove items 
    //   from the todoItems based on the passing index as an argument from this method --//
    deleteTodo = (index) => {
